...
_ENTITYUIPB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='lifeTime', full_name='EntityUiPb.lifeTime', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='locale', full_name='EntityUiPb.locale', index=2,
