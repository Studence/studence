from CommonCode.HashMap.Entry import Entry
from CommonCode.LinkedLIst.LinkedLIst import SingleEntryLinkedList
...
class HashMap(object):
    ...
    def remove(self, key):  # removing element by specified key
        ...
        old_value = last_entry.data.value
